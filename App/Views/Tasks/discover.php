...
<?php if(!isset($_SESSION['discoverCompleted'])): ?>
    ...
    <?php if($step == 0): ?>
        <section class="section">
            ...
            <p class="section__content">
                Pour ajouter un projet, cliquez sur le boutton en haut de la page <a class="add-button" href="<?= \Core\Helpers\Html::url("decouvrir/1") ?>">Projet.</a>
            </p>
            <p class="section__content">
    ...
    <section class="section section__hidden <?= $step == 2 ? 'section__visible' : '' ?>" id="add-task-section">
        ...
        <p class="section__content">
            Pour ajouter une tâche, cliquez sur le boutton en haut de la page <a class="add-button" href="<?= \Core\Helpers\Html::url("decouvrir/2") ?>">Tâche.</a>
        </p>
        <p class="section__content">
